...
mod compiler;
mod interpreter;
extern crate self as mod_l3;

extern crate l3_parser;

pub use compiler::l3_compiler;
pub use interpreter::l3_interpreter;

pub use l3_parser::L3_interpreter;
pub use l3_parser::L3;

#[cfg(test)]
mod tests {
    use crate::interpreter::l3_interpreter::{Expression, Variable};
    use crate::l3_compiler::Step;
    use crate::l3_interpreter::Expression::VALUE;
    use crate::l3_interpreter::{step, LinearStore, Location, Store};
    use l3_parser::L3_interpreter;
    ...
    fn interpreter_sum_test() {
        ...
        let sum = *evaluate(main, store).unwrap().get(&l3).unwrap();
    ...
    //     let sum = crate::l3_compiler::test_sum(10000);
    //     assert_eq!(sum, 50005000);
    // }
    //
    // #[test]
    // fn compiler_fn_test() {
    //     let sum = crate::l3_compiler::test_add(3);
    //     assert_eq!(sum, 5);
    // }
    //
    // #[test]
    // fn compiler_stack_test() {
    //     let sum = crate::l3_compiler::test_stack(3);
    //     assert_eq!(sum, 6);
    // }
    //
    // #[test]
    // fn compiler_test_higher_order_1() {
    //     let sum = crate::l3_compiler::test_higher_order_1(3);
    //     assert_eq!(sum, 5);
    // }
    //
    // #[test]
    // fn compiler_test_higher_order_2() {
    //     let sum = crate::l3_compiler::test_higher_order_2(3);
    //     assert_eq!(sum, 5);
    // }
    //
    // #[test]
    // fn compiler_test_higher_order_3() {
    //     let sum = crate::l3_compiler::test_higher_order_3(3);
    //     assert_eq!(sum, 9);
    // }
    //
    // #[test]
    // fn compiler_test_multiple_references() {
    //     let sum = crate::l3_compiler::test_multiple_references(3);
    //     assert_eq!(sum, 5);
    // }
    //
    // #[test]
    // fn compiler_test_multiple_use() {
    //     let sum = crate::l3_compiler::test_multiple_use(3);
    //     assert_eq!(sum, 8);
    // }
    //
    // #[test]
    // fn compiler_let_binding_test_1() {
    //     let sum = crate::l3_compiler::test_let_bindings_2(3);
    //     assert_eq!(sum, 7);
    // }
    //
    // #[test]
    // fn compiler_let_binding_test_2() {
    //     let sum = crate::l3_compiler::test_let_bindings_3(3);
    //     assert_eq!(sum, 13);
    // }
    //
    // // #[test]
    ...
    //     let sum = crate::l3_compiler::test_basic_rec_fn(5);
    //     assert_eq!(sum, 15)
    // }
    //
    // #[test]
    // fn compiler_recursive_function() {
    //     let sum = crate::l3_compiler::test_rec_fn(5);
    //     assert_eq!(sum, 20)
    // }
    //
    // #[test]
    // fn compiler_recursive_function2() {
    //     let sum = crate::l3_compiler::test_rec_fn_2(5);
    //     assert_eq!(sum, 15)
    // }
    //
    ...
    //     let now = Instant::now();
    //
    //     let l1 = super::l3_compiler::Location::from(4200000000);
    //     let l3 = super::l3_compiler::Location::from(0);
    //
    //     let main = crate::L3!(
    //         l3 := 0;
    //         while !l1 >= 1 do
    ...
    //     assert_eq!(l3.get(), 8820000002100000000);
    //     assert!(time < 0.00001)
    // }
}
